...
%Jak již bylo uvedeno v~kapitole \ref{det:mod}, když částice interaguje s~pixelem, pracujícím v~tomto módu, ve kterém zanechá část své energie, dojde k~vygenerování napěťového pulzu. 
